...
#define BT_RST_SetHigh() do { PORTB_OUTSET = 0x64; } while(0)
#define BT_RST_SetLow() do { PORTB_OUTCLR = 0x64; } while(0)
#define BT_RST_Toggle() do { PORTB_OUTTGL = 0x64; } while(0)
#define BT_RST_GetValue() (VPORTB.IN & (0x1 << 6))
#define BT_RST_SetDigitalInput() do { PORTB_DIRCLR = 0x64; } while(0)
#define BT_RST_SetDigitalOutput() do { PORTB_DIRSET = 0x64; } while(0)
...
#define IO_PA6_SetHigh() do { PORTA_OUTSET = 0x64; } while(0)
#define IO_PA6_SetLow() do { PORTA_OUTCLR = 0x64; } while(0)
#define IO_PA6_Toggle() do { PORTA_OUTTGL = 0x64; } while(0)
#define IO_PA6_GetValue() (VPORTA.IN & (0x1 << 6))
#define IO_PA6_SetDigitalInput() do { PORTA_DIRCLR = 0x64; } while(0)
#define IO_PA6_SetDigitalOutput() do { PORTA_DIRSET = 0x64; } while(0)
...
#define RGB_LED_SetHigh() do { PORTC_OUTSET = 0x32; } while(0)
#define RGB_LED_SetLow() do { PORTC_OUTCLR = 0x32; } while(0)
#define RGB_LED_Toggle() do { PORTC_OUTTGL = 0x32; } while(0)
#define RGB_LED_GetValue() (VPORTC.IN & (0x1 << 5))
#define RGB_LED_SetDigitalInput() do { PORTC_DIRCLR = 0x32; } while(0)
#define RGB_LED_SetDigitalOutput() do { PORTC_DIRSET = 0x32; } while(0)
